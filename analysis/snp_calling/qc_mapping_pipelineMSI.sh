...
#Then, unse the unique array above in shell script w/ SNP pipeline to submit to MSI queues
for F in "${uniq[@]}"
do
bash SNP_pipeline.sh -n ../../raw_reads/$F -g ../../reference_genomes/Puccinia_coronata_avenae_12SD80.primary.fa
done
